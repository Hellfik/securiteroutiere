...
<body id="page">
                    ...
                    <ul class="dropdown">
                        ...
                        <li class="second">
                            ...
                            <ul class="second_dropdown">
                                <li><a href="#"><i class="fas fa-angle-double-right"></i> Panneaux d'interdiction</a></li>
    ...
    <section id="bloc_accueil">
        ...
        <div class="bloc_title">
            <h2>PANNEAUX D'INTERDICTION</h2>
            <hr>
            <p>
                EN FRANCE IL EXISTE 41 PANNEAUX D'INTERDICTION
            </p>
    ...
    <section id="body">
        <div class="container">
            ...
            <div class="panneaux_intro">
                <h2>Les panneaux d'interdiction</h2>
                <hr>
            ...
            <div class="panneaux_container">
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B0.svg" alt="panneau a1"></div>
                        <hr>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B1.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B1</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B1j.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B1j</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B2a.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B2a</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B2b.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B2b</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B2c.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B2c</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B3.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B3</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B3a.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B3a</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B4.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B4</h4>
