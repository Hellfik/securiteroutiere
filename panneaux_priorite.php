...
<body id="page">
            ...
            <ul id="menu">
                ...
                <li class="menu-dropdown"><a href="">Panneaux <i class="fas fa-caret-down"></i></a>
                    <ul class="dropdown">
                        ...
                        <li>
                            <a href="#"><i class="fas fa-angle-double-right"></i> Type AB</a>
                        </li>
                        <li class="second">
    ...
    <section id="bloc_accueil">
        ...
        <div class="bloc_title">
            <h2>PANNEAUX PRIORITE</h2>
            <hr>
            <p>
                EN FRANCE IL EXISTE 9 PANNEAUX DE PRIORITE
            </p>
    ...
    <section id="body">
        <div class="container">
            ...
            <div class="panneaux_intro">
                <h2>Les panneaux de priorité</h2>
                <hr>
            ...
            <div class="panneaux_container">
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB1.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, ullam aspernatur? Unde, nobis? Culpa ea, impedit unde maiores doloremque veritatis dolores adipisci, perspiciatis nostrum, sint tempora quos. Dolorum, reprehenderit
                                alias? <br> <a href="https://fr.wikipedia.org/wiki/Panneau_de_signalisation_routi%C3%A8re_de_priorit%C3%A9_en_France" style="color:blue;"> >> Lire La suite</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB3a.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A2b</h4>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maxime numquam non possimus ducimus eaque nisi deserunt quis, eligendi officiis iure placeat, iste, quasi natus in! Pariatur sint ipsa harum ex. <br> <a href="https://fr.wikipedia.org/wiki/Panneau_de_signalisation_routi%C3%A8re_de_priorit%C3%A9_en_France"
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB3b.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A3</h4>
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatum veniam doloremque eaque quos explicabo neque facilis, vel recusandae accusantium rem laborum culpa aut, officiis velit id expedita iure perspiciatis sunt.
                                <br> <a href="https://fr.wikipedia.org/wiki/Panneau_de_signalisation_routi%C3%A8re_de_priorit%C3%A9_en_France" style="color:blue;"> >> Lire La suite</a></p>
                        </div>
                    </div>
                </div>
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB4.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A4</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB5.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A8</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB6.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A13a</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio ipsam repellendus commodi debitis unde saepe voluptatum, blanditiis accusamus eum minus corporis animi voluptatibus culpa dolorem reprehenderit, exercitationem
                                libero quis voluptas! <br> <a href="https://fr.wikipedia.org/wiki/Panneau_de_signalisation_routi%C3%A8re_de_priorit%C3%A9_en_France" style="color:blue;"> >> Lire La suite</a></p>
                        </div>
                    </div>
                </div>
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB7.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A14</h4>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis nostrum quas necessitatibus modi impedit exercitationem nulla doloremque molestias corrupti dolorum, saepe tempora, sit minus repudiandae laborum? Consequatur
                                natus perferendis fugiat! <br> <a href="https://fr.wikipedia.org/wiki/Panneau_de_signalisation_routi%C3%A8re_de_priorit%C3%A9_en_France" style="color:blue;"> >> Lire La suite</a></p>
                        </div>
                    </div>
                </div>
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/AB25.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>A15a1</h4>
