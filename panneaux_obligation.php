...
<body id="page">
                    ...
                    <ul class="dropdown">
                        ...
                        <li class="second">
                            ...
                            <ul class="second_dropdown">
                                ...
                                <li><a href="#"><i class="fas fa-angle-double-right"></i> Panneaux d'obligation</a></li>
    ...
    <section id="bloc_accueil">
        ...
        <div class="bloc_title">
            <h2>PANNEAUX D'OBLIGATION</h2>
            <hr>
            <p>
                EN FRANCE IL EXISTE 18 PANNEAUX D'OBLIGATION
            </p>
    ...
    <section id="body">
        <div class="container">
            ...
            <div class="panneaux_intro">
                <h2>Les panneaux d'obligation</h2>
                <hr>
            ...
            <div class="panneaux_container">
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21-1.svg" alt="panneau a1"></div>
                        <hr>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21-2.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21-2</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21a1.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21a1</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21a2.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21a2</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21b.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21b</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21c1.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21c1</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21c2.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21c2</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21d1.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21d1</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img src="img/B21d2.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>B21d2</h4>
