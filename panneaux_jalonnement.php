...
<body id="page">
            ...
            <ul id="menu">
                ...
                <li class="menu-dropdown"><a href="">Panneaux <i class="fas fa-caret-down"></i></a>
                    <ul class="dropdown">
                        ...
                        <li>
                            <a href="#"><i class="fas fa-angle-double-right"></i> Type Dp</a>
                        </li>
                        <li>
    ...
    <section id="bloc_accueil">
        ...
        <div class="bloc_title">
            <h2>PANNEAUX DE JALONNEMENT PIETONNIER</h2>
            <hr>
            <p>
                EN FRANCE IL EXISTE 4 PANNEAUX DE JALONNEMENT PIETONNIER
            </p>
    ...
    <section id="body">
        <div class="container">
            ...
            <div class="panneaux_intro">
                <h2>Les panneaux de jalonnement piétonnier</h2>
                <hr>
            ...
            <div class="panneaux_container">
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img style="height:50px;" src="img/Dp1a.svg" alt="panneau a1"></div>
                        <hr>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img style="height:50px;" src="img/Dp1b.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>Dp1b</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img style="height:50px;" src="img/Dp2a.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>Dp2a</h4>
                ...
                <div class="groupement_panneaux">
                    <div class="panneaux__content">
                        <div class="panneaux__img"><img style="height:50px;" src="img/Dp2b.svg" alt="panneau a1"></div>
                        <hr>
                        <div class="panneau__description">
                            <h4>Dp2b</h4>
